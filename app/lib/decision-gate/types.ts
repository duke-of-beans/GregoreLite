 ...
 *
 * Stubbed in Sprint 4A (NLP inference needed — wired in Sprint 4B):
...
export type GateTrigger =
  ...
  | 'high_tradeoff_count'     // decision involves ≥4 major tradeoffs [STUB — 4B]
  | 'multi_project_touch'     // decision touches ≥2 projects [STUB — 4B]
  | 'sacred_principle_risk'   // forbidden phrases detected
  | 'irreversible_action'     // delete, deploy to prod, breaking schema change
  | 'large_build_estimate'    // build time >3 Agent SDK sessions [STUB — 4B]
